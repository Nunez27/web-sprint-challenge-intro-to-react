...
Stores information from api

1. Describe props.
Props is used to pass data around from one component to another.
1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
Side effects allow you to change something directly to the dom.
